...
class WeekData {
	...
	public static function reloadWeekFiles(isStoryMode:Null<Bool> = false)
	{
		...
		var modsListPath:String = #if android StorageUtil.getExternalStorageDirectory() + #else Sys.getCwd() + #end 'modsList.txt';
	...
	public static function loadTheFirstEnabledMod()
	{
		...
		#if MODS_ALLOWED
		if (FileSystem.exists(#if android StorageUtil.getExternalStorageDirectory() + #else Sys.getCwd() + #end "modsList.txt"))
		{
			var list:Array<String> = CoolUtil.listFromString(File.getContent(#if android StorageUtil.getExternalStorageDirectory() + #else Sys.getCwd() + #end "modsList.txt"));
