...
class Native
{
	...
	public static function fixScaling():Void
	{
		...
		if (display != null)
		{
			...
			@:privateAccess Application.current.window.width = Std.int(Main.gameWidth * dpiScale);
			@:privateAccess Application.current.window.height = Std.int(Main.gameHeight * dpiScale);
